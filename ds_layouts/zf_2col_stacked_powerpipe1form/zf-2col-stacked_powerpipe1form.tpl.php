...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="zf-2col-stackeds <?php print $classes;?>">
  ...
  <?php if (!empty($left) || !empty($right)): ?>
    <div class="<?php print $zf_wrapper_classes; ?>">
      <<?php print $left_wrapper ?> class="small-12 large-8 columns <?php print $left_classes; ?>">
      <?php print $left; ?>
      </<?php print $left_wrapper ?>>

      <<?php print $right_wrapper ?> class="small-12 large-4 columns right-column<?php print $right_classes; ?>">
      <?php print $right; ?>
